subroutine f_ef_deriv2ab( &
           ...
           beta, g_e_x, g_f_x, &
           natom, natom_x, energy, energy0, force, force0, charge, volume )
!use cublas
implicit none
...
double precision dummy, dummy_wa, volume
...
double precision array_i1( network_x(1)-1, natom_x )!, array_o1( network_x(1) )
!double precision array_i1( network_x(1), natom_x ), array_o1( network_x(1) ) !ACADEMEIA version
...
integer index_1d
integer index_1d_ll2_ll3_l2
integer index_1d_ll3_l2

double precision const_a_ar((network_x(1)-1)*network_x(2)*network_x(3))
double precision const_b_ar((network_x(1)-1)*network_x(2)*network_x(3))
double precision const_c_ar((network_x(1)-1)*network_x(2)*network_x(3))
double precision const_d_ar((network_x(1)-1)*network_x(2)*network_x(3))
double precision const_e_ar((network_x(1)-1)*network_x(2)*network_x(3))
!double precision const_a_ar(network_x(1)*network_x(2)*network_x(3)) !ACADEMEIA version
!double precision const_b_ar(network_x(1)*network_x(2)*network_x(3)) !ACADEMEIA version
!double precision const_c_ar(network_x(1)*network_x(2)*network_x(3)) !ACADEMEIA version
!double precision const_d_ar(network_x(1)*network_x(2)*network_x(3)) !ACADEMEIA version
!double precision const_e_ar(network_x(1)*network_x(2)*network_x(3)) !ACADEMEIA version

double precision const1_ar(natom_x, network_x(2)*network_x(3))
double precision const2_ar(natom_x, (network_x(1)-1)*network_x(2)*network_x(3))
!double precision const2_ar(natom_x, network_x(1)*network_x(2)*network_x(3)) !ACADEMEIA version
double precision const3_ar(natom_x, (network_x(1)-1)*network_x(2)*network_x(3))
!double precision const3_ar(natom_x, network_x(1)*network_x(2)*network_x(3)) !ACADEMEIA version

double precision array_o1_ar1(network_x(1)-1, network_x(2)*network_x(3))
!double precision array_o1_ar1(network_x(1), network_x(2)*network_x(3)) !ACADEMEIA version
double precision array_o1_ar2(network_x(1)-1, (network_x(1)-1)*network_x(2)*network_x(3))
!double precision array_o1_ar2(network_x(1), network_x(1)*network_x(2)*network_x(3)) !ACADEMEIA version

double precision array_o2_ar(network_x(2), (network_x(1)-1)*network_x(2)*network_x(3))
!double precision array_o2_ar(network_x(2), network_x(1)*network_x(2)*network_x(3)) !ACADEMEIA version
...
!call cpu_time(t0)
 ...
 enddo
 ! charge
 di = 1 + sum( num_g_x(1:5) )
 do i = 1, natom_x
   input_x(i,di) = dble( charge )*100.0d0/volume
 enddo
 ...
 if( nlayer_x == 4 )then
   ...
   h2_0 = 1 + network_x(2)
     ...
     do l2 = 1, network_x(2)
       ...
       do l1 = 0, network_x(1) !-1 !-1 by volume?
   ...
   if( beta /= 0.0d0 )then
     ...
     do j = 1, natom_x
       do l1 = 1, network_x(1)-1 !-1 by volume
     ...
     do ll1 = 1, network_x(1)-1 !-1 by volume
       do j = 1, natom_x
       ...
       do ll2 = 1, network_x(2)
         ...
         do ll3 = 1, network_x(3)
           index_1d = ll3 + (ll2 - 1) * network_x(3) + (ll1 -1) * network_x(2) * network_x(3)
           hh2      = h2_0 + ( 1 + ll3 )
           ...
           do ll4 = 1, network_x(4)
             ...
             const_b_ar(index_1d) = 0.0d0
             do j = 1, natom_x
               d1                           = const(j) * hidden_x(j,hh1)
               const3_ar(j,index_1d) = d1 !const(j) * hidden_x(j,hh1)
               const_b_ar(index_1d)   = const_b_ar(index_1d) + d1
             enddo

             const_a_ar(index_1d) = 0.0d0
             do j = 1, natom_x
               d1                           = const(j) * hidden_x(j,hh2)
               const2_ar(j,index_1d) = d1 !const(j) * hidden_x(j,hh2)
               const_a_ar(index_1d)   = const_a_ar(index_1d) + d1 
             enddo ! j

             const_c_ar(index_1d) = 0.0d0
             const_d_ar(index_1d) = 0.0d0
             const_e_ar(index_1d) = 0.0d0
             do j = 1, natom_x
               const_c_ar(index_1d) = const_c_ar(index_1d) + ( const(j) * inv_1 )
               const_d_ar(index_1d) = const_d_ar(index_1d) + ( const(j) * inv_2 )
               const_e_ar(index_1d) = const_e_ar(index_1d) + ( const(j) * inv_3 )
             enddo
           end do
         end do
       end do
       ...
       !-----------
       !BIAS, l1 = 0
     CALL Dgemm('N', 'N', network_x(2), (network_x(1)-1)*network_x(2)*network_x(3), natom_x, 1.0d0, array_i2, network_x(2), &
                const2_ar, natom_x, 0.0d0, array_o2_ar, network_x(2))
     !CALL Dgemm('N', 'N', network_x(2), network_x(1)*network_x(2)*network_x(3), natom_x, 1.0d0, array_i2, network_x(2), &
     !           const2_ar, natom_x, 0.0d0, array_o2_ar, network_x(2)) !ACADEMEIA version
!!$acc data copyin(array_i2,const2_ar) copyout(array_o2_ar) 
!     CALL cublasDgemm('N', 'N', network_x(2), network_x(1)*network_x(2)*network_x(3), natom_x, 1.0d0, array_i2, network_x(2), &
!                const2_ar, natom_x, 0.0d0, array_o2_ar, network_x(2))
!!$acc end data
         ...
         do ll3 = 1, network_x(3)
           ...
           do ll4 = 1, network_x(4)
             ...
             do l2 = 1, network_x(2) 
               ...
               g_f_x(w1) = g_f_x(w1) + ( array_o2_ar(l2,index_1d) * weight_x(www2) )
               !do j = 1, natom_x
                 !g_f_x(w1) =   g_f_x(w1) &
             ...
             enddo ! l2
             w1 = ww1_1 + 1 
             g_f_x(w1) = g_f_x(w1) + const_b_ar(index_1d)
           end do
         end do
       end do
     end do
         ...
         do ll3 = 1, network_x(3)
           ...
           do ll4 = 1, network_x(4)
             ...
             do l2 = 1, network_x(2)
               www2 = www2_1 + ( 1 + l2 ) !w2_0 + ( 1 + network_x(2) )*( ll3 - 1 ) + ( 1 + l2 )
               h1 = 1 + l2
               index_1d_ll3_l2 = l2 + (ll3 - 1) * network_x(2)
               do j = 1, natom_x
                 const1_ar(j, index_1d_ll3_l2)  = const1_ar(j, index_1d_ll3_l2) + const2_ar(j, index_1d) * dhidden_x(j,h1) ! * weight_x(www2)
               enddo ! j
             end do
           end do
         end do
     ...
     CALL Dgemm('N', 'N', network_x(1)-1, network_x(3)*network_x(2), natom_x, 1.0d0, array_i1, network_x(1)-1, &
                const1_ar, natom_x, 0.0d0, array_o1_ar1, network_x(1)-1)
     !CALL Dgemm('N', 'N', network_x(1), network_x(3)*network_x(2), natom_x, 1.0d0, array_i1, network_x(1), &
     !           const1_ar, natom_x, 0.0d0, array_o1_ar1, network_x(1)) !ACADEMEIA version
     CALL Dgemm('N', 'N', network_x(1)-1, (network_x(1)-1)*network_x(2)*network_x(3), natom_x, 1.0d0, array_i1, network_x(1)-1, &
                const3_ar, natom_x, 0.0d0, array_o1_ar2, network_x(1)-1)
     !CALL Dgemm('N', 'N', network_x(1), network_x(1)*network_x(2)*network_x(3), natom_x, 1.0d0, array_i1, network_x(1), &
     !           const3_ar, natom_x, 0.0d0, array_o1_ar2, network_x(1)) !ACADEMEIA version
     CALL Dgemm('N', 'N', network_x(2), (network_x(1)-1)*network_x(2)*network_x(3), natom_x, 1.0d0, array_i3, network_x(2), &
                const2_ar, natom_x, 0.0d0, array_o2_ar, network_x(2))
     !CALL Dgemm('N', 'N', network_x(2), network_x(1)*network_x(2)*network_x(3), natom_x, 1.0d0, array_i3, network_x(2), &
     !           const2_ar, natom_x, 0.0d0, array_o2_ar, network_x(2)) !ACADEMEIA version
!!$acc data copyin(array_i1,array_i3,const1_ar,const3_ar,const2_ar) copyout(array_o1_ar1,array_o1_ar2,array_o2_ar) 
!     CALL cublasDgemm('N', 'N', network_x(1), network_x(3)*network_x(2), natom_x, 1.0d0, array_i1, network_x(1), &
!                const1_ar, natom_x, 0.0d0, array_o1_ar1, network_x(1))
!     CALL cublasDgemm('N', 'N', network_x(1), network_x(1)*network_x(2)*network_x(3), natom_x, 1.0d0, array_i1, network_x(1), &
!                const3_ar, natom_x, 0.0d0, array_o1_ar2, network_x(1))
!     CALL cublasDgemm('N', 'N', network_x(2), network_x(1)*network_x(2)*network_x(3), natom_x, 1.0d0, array_i3, network_x(2), &
!                const2_ar, natom_x, 0.0d0, array_o2_ar, network_x(2))
!!$acc end data
       ...
       do ll4 = 1, network_x(4)
         ...
         do l2 = 1, network_x(2)
           ...
           do l1 = 1, network_x(1)-1 !-1 by volume
             ...
             g_f_x(w1) = g_f_x(w1)  + ( array_o1_ar1(l1,index_1d_ll3_l2)  * weight_x(www2) )
     ...
     do ll1 = 1, network_x(1)-1 !-1 by volume
       ...
       !h1 == hh1 : l2 == ll2
           do ll4 = 1, network_x(4)
             do l1 = 1, network_x(1)-1 !-1 by volume !0, network_x(1) !*****
               w1_1 = ( 1 + network_x(1) )*( ll2 - 1 ) + ( 1 + l1 )
               g_f_x(w1_1) = g_f_x(w1_1) + array_o1_ar2(l1,index_1d)
             enddo ! l1
           end do

           do ll4 = 1, network_x(4)
             g_f_x(ww1) = g_f_x(ww1) - const_c_ar(index_1d) !dummy_wa
             ...
             !do l3 = 1, network_x(3)
               ...
               g_f_x(w2) = g_f_x(w2) + const_a_ar(index_1d)
               !do j = 1, natom_x
         ...
         !do l3 = 1, network_x(3)
           !if( l3 /= ll3 ) cycle
             do l2 = 1, network_x(2)
               ...
               g_f_x(w2) = g_f_x(w2) + array_o2_ar(l2,index_1d)
             ...
             ww2 = w2_0 + ( 1 + network_x(2) )*( ll3 - 1 ) + ( 1 + ll2 )
             g_f_x(ww2) = g_f_x(ww2) - const_d_ar(index_1d) !dummy_wa
             ...
             !do l4 = 1, network_x(4)
               ...
               !do l3 = 1, network_x(3) !0, network_x(3)
                 !if( l3 /= ll3 ) cycle
                   g_f_x(ww3) = g_f_x(ww3) - const_e_ar(index_1d) !dummy_wa
