...
integer io_weight, io_list, percent_tst, memory, iprint, itest, max_epoch
double precision factr, pgtol, alpha, beta, rmse_e_thr, rmse_f_thr
...
!B
 ...
 do i = 1, counter
   ...
   if( tag == "rmse_e_thr" )then
     read(cread,*) dread
     rmse_e_thr  = dread
   endif
   if( tag == "rmse_f_thr" )then
     read(cread,*) dread
     rmse_f_thr  = dread
   endif
   if( tag == "max_epoch" )then
     read(cread,*) iread
     max_epoch   = iread
   endif
 ...
 if( io_list == 1 ) write(*,*) " Reading list.dat file"
 write(*,*) " "
 ...
 write(*,*) " "
 write(*,*) " rmse_e_thr = ", rmse_e_thr, "eV/atom"
 write(*,*) " rmse_f_thr = ", rmse_f_thr, "eV/ang"
 write(*,*) " max_epoch = ", max_epoch
 write(*,*) " "
