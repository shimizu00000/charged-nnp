...
!*************************************************************
 ...
 call read_io_nnp2( io_nnp_a, io_nnp_b )
...
!--------------------------------
 ...
 if( io_nnp_a == 1 .and. io_nnp_b == 1 )then
   ...
   write(*,*) " Allocate G2_maxmin(b-a,b-b),&
              &G5_maxmin(b-aa,b-ab,b-bb)"
 endif
...
1111 format( A120 )
   ...
   read(1)volume
   write(*,*) " "
   write(*,*) " MD steps: ", md_steps, charge, volume
   write(*,*) " "
 ...
 write(*,*) " "
   ...
   deallocate( g2_a_a_maxmin,  g2_a_b_maxmin, &
               g5_a_aa_maxmin, g5_a_ab_maxmin, &
               g5_a_bb_maxmin )
   deallocate( g2_b_a_maxmin,  g2_b_b_maxmin, &
               g5_b_aa_maxmin, g5_b_ab_maxmin, &
               g5_b_bb_maxmin )
